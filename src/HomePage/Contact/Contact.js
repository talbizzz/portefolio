      ...
      <footer className="mt5 pa4 pa5-l">
        ...
        >
          <div className="mb4 mb0-ns w-100 tc">
            <a className="black-70 f3 f2-ns fw6 tl link dim dib pv3 mt6 mb4" href="mailto:hello@celinez.com" >
        ...
        <div id="footer" className="dt dt--fixed w-100 pv2" style={{borderTop:"solid 1px #cbcdd3"}} >
          <div className="dn dtc-ns v-mid">
            <p className="f7 black-70 dib pr3">
